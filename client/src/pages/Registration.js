...
const userreg = e => {
  e.preventDefault();
  console.log(second);
    axios.post("http://localhost:2000/user/add-user",second).then((res)=>{
      console.log(res);
    })
          ...
          <div className="container h-100">
                  ...
                  <div className="card-body p-5">
                    ...
                    <form onSubmit={userreg}>
                      <div className="form-outline mb-4">
                        <input type="text" id="form3Example1cg" name="name" onChange={change} className="form-control form-control-lg" />
                        <label className="form-label" htmlFor="form3Example1cg">Name</label>
                      </div>
                      <div className="form-outline mb-4">
                        <input type="number" id="form3Example3cg" name="mobile" onChange={change} className="form-control form-control-lg" />
                        <label className="form-label" htmlFor="form3Example3cg">Mobile</label>
                      </div>
                      <div className="form-outline mb-4">
                        <input type="text" id="form3Example4cg" name="address"  onChange={change} className="form-control form-control-lg" />
                        <label className="form-label" htmlFor="form3Example4cg">address</label>
                      </div>
                      <div className="form-outline mb-4">
                        <input type="password" id="form3Example4cdg" name="email" onChange={change} className="form-control form-control-lg" />
                        <label className="form-label" htmlFor="form3Example4cdg">E-mail</label>
                      </div>
            ...
            {/* <form>
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" id="examplemobile" placeholder="Mobilenumber" />
                </div>
                <div class="form-group">
